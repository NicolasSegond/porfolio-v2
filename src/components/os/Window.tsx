...
export function Window({
  ...
  const style: React.CSSProperties = maximized
    ? { zIndex, position: "absolute", left: 0, top: MENUBAR_H, width: "100vw", height: `calc(100vh - ${MENUBAR_H}px)`, borderRadius: 0, transition: "left .3s ease, top .3s ease, width .3s ease, height .3s ease, border-radius .2s ease" }
